...
/*   Updated: 2025/02/02 19:37:30 by dangtran         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//         // Pour débugguer
//         printf("REMETTRE DANS L'ORDRE INITIALE- Pile B : ");
//         print_stack(*stack_b);

//         printf("REMETTRE DANS L'ORDRE INITIALE  - Pile A : ");
//         print_stack(*stack_a);
        
//         if ((*stack_b)->head == NULL || (*stack_b)->head->next == NULL)
//         {
//             printf("DANS LE IF - A = %d, B = %d\n", (*stack_a)->head->number, (*stack_b)->head->number);
...
//         printf("REMETTRE DANS L'ORDRE AVANT HEAD->NEXT - Pile B : ");
//         print_stack(*stack_b);
//         (*stack_a)->size++;
